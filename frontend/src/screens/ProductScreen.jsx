...
export default function ProductScreen() {
  ...
  return (
    <div className="container mx-auto mt-8 p-4">
      <Link to={'/'}>
        <button className="bg-[#313133] hover:bg-[#e5e5e5] text-white px-4 py-2 rounded-md mb-4">Go Back</button>
      </Link>
      {isLoading ? (
        <Spinner />
      ) : error ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="md:col-span-1 p-4">
            ...
            <button
              className="bg-[#FF7A1A] text-white px-4 py-2 rounded-md mt-4 hover:bg-[#383838]"
      ...
      <div className="mt-8">
        ...
        <div className="mt-4">
          <h3 className="text-lg font-semibold">Write a Review</h3>
          <p className="text-gray-700">Please <Link to="/login" className="text-[#FF7A1A] hover:underline">log in</Link> to write a review.</p>
        </div>
      </div>
    </div>
  );
